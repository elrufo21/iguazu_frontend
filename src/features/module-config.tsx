...
export const modules: Record<string, ResourceConfig> = {
  ...
  staffPayments: {
    ...
    description: "Pagos calculados o manuales por periodo.",
    ...
    fields: [
      ...
      { name: "amount", label: "Monto manual", type: "number", step: "0.01" },
      {
        name: "paymentMethod",
        label: "Pago",
        type: "select",
    ...
    columns: [
      { header: "Empleado", accessor: "employee.fullName" },
      { header: "Monto", accessor: "amount", render: money },
      { header: "Inicio", accessor: "periodStart", render: dateTime },
      { header: "Fin", accessor: "periodEnd", render: dateTime },
      { header: "Fecha", accessor: "createdAt", render: dateTime },
    ],
  },
  staffDiscounts: {
