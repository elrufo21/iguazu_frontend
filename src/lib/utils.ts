...
export const columnLabels: Record<string, string> = {
  ...
  realSalePrice: 'Precio real prom.',
  unitPrice: 'Precio',
  ...
  room: 'Habitación',
  customer: 'Cliente',
  revenue: 'Ingreso real',
  averageSalePrice: 'Precio real prom.',
  minSalePrice: 'Precio mín.',
  maxSalePrice: 'Precio máx.',
  category: 'Categoría',
  amount: 'Monto',
  label: 'Periodo',
  description: 'Descripción',
  occurredAt: 'Fecha',
  cashOpenedBy: 'Caja abierta por',
  workShift: 'Turno',
};
